...
@section('title', 'Tin nhanh | Trang tin tức mới cập nhật')
@section('main')
    @include('home.new_posts')
    @include('home.highlight_posts')
    @include('home.category1_posts')
    @include('home.hot_posts')
    @include('home.category2_posts')
